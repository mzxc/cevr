...
/**
 * BizTicketType generated by hbm2java
 */
@Entity
@Table(name = "biz_ticket_type", catalog = "cevr")
public class BizTicketType implements java.io.Serializable {
	...
	public BizTicketType() {
	}

	public BizTicketType(String id) {
		this.id = id;
	}

	public BizTicketType(String id, String typeName, String typeInfo, String deleteflag, String cancleflag,
