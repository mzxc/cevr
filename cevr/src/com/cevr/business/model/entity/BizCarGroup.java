...
/**
 * BizCarGroup generated by hbm2java
 */
@Entity
@Table(name = "biz_car_group", catalog = "cevr")
public class BizCarGroup implements java.io.Serializable {
	...
	public BizCarGroup(String id) {
		this.id = id;
	}

	public BizCarGroup(String id, String groupName, String groupInfo, String orderNum, String deleteflag,
