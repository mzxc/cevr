...
/**
 * DicImgType generated by hbm2java
 */
@Entity
@Table(name = "dic_img_type", catalog = "cevr")
public class DicImgType implements java.io.Serializable {
	...
	public DicImgType(String id) {
		this.id = id;
	}

	public DicImgType(String id, String typeName, String typeInfo, String deleteflag, String cancleflag,
