...
/**
 * BizTicket generated by hbm2java
 */
@Entity(name = "biz_ticket")
public class BizTicket implements java.io.Serializable {
	...
	public BizTicket(String id, int ticketNum, String clickPeopleId, String clickCarId) {
		this.id = id;
