...
public class BizTicket2001 implements java.io.Serializable {
    ...
    public BizTicket2001(String id, String fromIp, Date clickTime, int ticketNum, String ticketTypeId, String clickPeopleId, String clickCarId, String deleteflag, String cancleflag, String holdflag, Date createtime, Date updatetime, String operatorId) {
        this.id = id;
        this.fromIp = fromIp;
