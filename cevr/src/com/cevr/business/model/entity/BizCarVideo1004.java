...
public class BizCarVideo1004 implements java.io.Serializable {
	...
	public BizCarVideo1004(String id, String carId) {
		this.id = id;
		this.carId = carId;
	}

	public BizCarVideo1004(String id, String src, String deleteflag,String carId,
			String cancleflag, String holdflag, Date createtime, Date updatetime) {
		this.id = id;
		this.src = src;
		this.carId = carId;
