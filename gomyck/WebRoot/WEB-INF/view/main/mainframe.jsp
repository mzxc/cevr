	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            ...
	            <div class="col-sm-12 h-info">
	                活动说明：2017gomyck电动汽车挑战赛有人气更接地气！赛事14项专业评测项目中外观设计，空间设计、内饰设计3个评测项目，将进行VR视频网络互动投票。          360°全景视频体验，让您全面了解参赛车型的各个细节，您的投票分数将加权计入最终评分，谁能拿到大奖，也有您的功劳哦~把握您的网络评委权利，动动手指，选出你心目中的各项最佳车型吧~              成为网络评委，还有福利哦~将抽取30名随机赠送参赛电动汽车模型及精美周边纪念品（温馨提示：请您填写真实手机号，以便获奖后客服与您及时联系，获奖名单将在6月23号后，于环青海湖国际电动汽车挑战赛的官方微信公众号公布。
	            </div>
	        </div>
	    </div>
	</header>
